...
namespace Realtime.Ortc.Internal
{
    ...
    /// <remarks>
    ///     All public and protected members of <see cref="RealtimeDictionary{TKey,TValue}" /> are thread-safe and may be
    ///     used
    ...
    public class RealtimeDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
    {
        ...
        ///     <see
        ///         cref="RealtimeDictionary{TKey,TValue}" />
        ///     class that is empty, has the default concurrency level, has the default initial capacity, and
        ///     uses the default comparer for the key type.
        /// </summary>
        public RealtimeDictionary() : this(DefaultConcurrencyLevel, DEFAULT_CAPACITY)
        {
        }
        ...
        ///     <see cref="RealtimeDictionary{TKey,TValue}" /> concurrently.
        /// </param>
        /// <param name="capacity">
        ...
        ///     0.
        /// </exception>
        public RealtimeDictionary(int concurrencyLevel, int capacity)
            : this(concurrencyLevel, capacity, EqualityComparer<TKey>.Default)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RealtimeDictionary{TKey,TValue}" />
        ///     class that contains elements copied from the specified
        ///     <see
        ///         cref="T:System.Collections.IEnumerable{KeyValuePair{TKey,TValue}}" />
        ...
        ///     the new
        ///     <see cref="RealtimeDictionary{TKey,TValue}" />.
        /// </param>
        ...
        ///     duplicate keys.
        /// </exception>
        public RealtimeDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        ...
        ///     (Nothing in Visual Basic).
        /// </exception>
        public RealtimeDictionary(IEqualityComparer<TKey> comparer)
        ...
        /// </exception>
        public RealtimeDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
        ...
        ///     (Nothing in Visual Basic).
        /// </exception>
        public RealtimeDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer)
        {
            if (concurrencyLevel < 1)
            {
                throw new ArgumentOutOfRangeException("concurrencyLevel",
                    GetResource("ConcurrentDictionary_ConcurrencyLevelMustBePositive"));
            }
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException("capacity",
                    GetResource("ConcurrentDictionary_CapacityMustNotBeNegative"));
            }
            if (comparer == null)
                throw new ArgumentNullException("comparer");
        ...
        /// <summary>
        ///     Gets a value that indicates whether the <see cref="RealtimeDictionary{TKey,TValue}" /> is empty.
        /// </summary>
        /// <value>
        ///     true if the <see cref="RealtimeDictionary{TKey,TValue}" /> is empty; otherwise,
        ///     false.
        /// </value>
        public bool IsEmpty
        {
        ...
        /// <summary>
        ///     Determines whether the <see cref="RealtimeDictionary{TKey,TValue}" /> contains the specified
        ///     key.
        /// </summary>
        /// <param name="key">The key to locate in the <see cref="RealtimeDictionary{TKey,TValue} 
        /// TValue}" />.</param>
        /// <returns>
        ///     true if the <see cref="RealtimeDictionary{TKey,TValue}" /> contains an element with
        ...
        ///     the
        ///     <see cref="RealtimeDictionary{TKey,TValue}" /> with the spedified key or the default value of
        ///     <typeparamref name="TValue" />, if the operation failed.
        /// </param>
        /// <returns>
        ///     true if the key was found in the <see cref="RealtimeDictionary{TKey,TValue}" />;
        ///     otherwise, false.
        /// </returns>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="key" /> is a null reference
        ...
        /// <summary>
        ///     Removes all keys and values from the <see cref="RealtimeDictionary{TKey,TValue}" />.
        /// </summary>
        public void Clear()
        {
            var locksAcquired = 0;
        ...
        ///     .
        /// </summary>
        /// <returns>An enumerator for the <see cref="RealtimeDictionary{TKey,TValue}" />.</returns>
        /// <remarks>
        ...
        /// <summary>
        ///     Attempts to add the specified key and value to the <see cref="RealtimeDictionary{TKey,TValue} 
        /// TValue}" />.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        ///     true if the key/value pair was added to the <see cref="RealtimeDictionary{TKey,TValue} 
        /// TValue}" />
        ...
        /// </exception>
        /// <exception cref="T:System.OverflowException">
        ///     The <see cref="RealtimeDictionary{TKey,TValue}" />
        ...
        ///     <see cref="RealtimeDictionary{TKey,TValue}" /> or the default value of
        ///     <typeparamref
        ///         name="TValue" />
        ...
        /// <summary>
        ///     Copies the key and value pairs stored in the <see cref="RealtimeDictionary{TKey,TValue}" /> to a
        ///     new array.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///     Adds a key/value pair to the <see cref="RealtimeDictionary{TKey,TValue}" />
        ...
        /// <summary>
        ///     Adds a key/value pair to the <see cref="RealtimeDictionary{TKey,TValue}" /> if the key does not already
        ///     exist, or updates a key/value pair in the <see cref="RealtimeDictionary{TKey,TValue}" /> if the key
        ///     already exists.
        /// </summary>
            ...
            try
            {
                ...
                for (var i = 0; i < buckets.Length; i++)
                {
                    ...
                    while (current != null)
                    {
                        ...
                        newBuckets[newBucketNo] = new Node(current.m_key, current.m_value, current.m_hashcode,
        ...
        private class DictionaryEnumerator : IDictionaryEnumerator
        {
            ...
            internal DictionaryEnumerator(RealtimeDictionary<TKey, TValue> dictionary)
            {
        ...
        /// </summary>
        /// <value>
        ///     An <see cref="T:System.Collections.Generic.ICollection{TKey}" /> containing the keys in the
        ...
        /// </summary>
        /// <value>
        ///     An <see cref="T:System.Collections.Generic.ICollection{TValue}" /> containing the values in
        ///     the
        ///     <see cref="T:System.Collections.Generic.Dictionary{TKey,TValue}" />.
        /// </value>
        ...
        ///     The <see cref="T:System.Collections.Generic.KeyValuePair{TKey,TValue}" />
        ...
        /// </param>
        /// <exception cref="T:System.ArgumentNullException">
        ///     The <paramref name="keyValuePair" /> of
        ///     <paramref
        ///         name="keyValuePair" />
        ///     is null.
        /// </exception>
        ...
        ///     <see
        ///         cref="T:System.Collections.Generic.ICollection{TValue}" />
        ///     .
        /// </param>
        /// <returns>
        ///     true if the <paramref name="keyValuePair" /> is found in the
        ///     <see
        ///         cref="T:System.Collections.Generic.ICollection{TKey,TValue}" />
        ///     ; otherwise, false.
        /// </returns>
        ...
        /// </summary>
        /// <value>
        ///     true if the <see cref="T:System.Collections.Generic.ICollection{TKey,TValue}" /> is
        ...
        ///     <typeparamref
        ///         name="TKey" />
        ///     of the <see cref="T:System.Collections.Generic.Dictionary{TKey,TValue}" />. -or-
        ...
        /// <summary>
        ///     Provides an <see cref="T:System.Collections.Generics.IDictionaryEnumerator" /> for the
        ///     <see cref="T:System.Collections.Generic.IDictionary{TKey,TValue}" />.
        /// </summary>
        /// <returns>
        ///     An <see cref="T:System.Collections.Generics.IDictionaryEnumerator" /> for the
        ///     <see
        ///         cref="T:System.Collections.Generic.IDictionary{TKey,TValue}" />
        ///     .
        /// </returns>
        ...
        /// </summary>
        /// <value>
        ///     true if the <see cref="T:System.Collections.Generic.IDictionary{TKey,TValue}" /> has a
        ///     fixed size; otherwise, false. For
        ///     <see
        ///         cref="T:System.Collections.Generic.ConcurrentDictionary{TKey,TValue}" />
        ///     , this property always
        ///     returns false.
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///     true if the <see cref="T:System.Collections.Generic.IDictionary{TKey,TValue}" /> is
        ///     read-only; otherwise, false. For
        ///     <see
        ///         cref="T:System.Collections.Generic.ConcurrentDictionary{TKey,TValue}" />
        ///     , this property always
        ...
        /// </summary>
        /// <value>
        ///     An <see cref="T:System.Collections.ICollection" /> containing the keys of the
        ///     <see
        ///         cref="T:System.Collections.Generic.IDictionary{TKey,TValue}" />
        ///     .
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///     An <see cref="T:System.Collections.ICollection" /> containing the values in the
        ///     <see
        ///         cref="T:System.Collections.IDictionary" />
        ///     .
        /// </value>
        ...
        ///     <see
        ///         cref="T:System.Collections.Concurrent.ConcurrentDictionary{TKey,TValue}" />
        ///     , this property always
        ///     returns false.
        /// </value>
